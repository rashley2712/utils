...
if __name__ == "__main__":
	...
	defaultWavelength = HA_labwavelength # Blueward doublet line in Angstrom
	defaultVelocity = 0.0
	...
	for spectrum in spectra:
		...
		print "Centroid wavelength %f [%f]"%(wavelength, wavelengthError)
		velocity = (wavelength - HA_labwavelength)/HA_labwavelength * 3E5 
		velocityError = 3E5 /HA_labwavelength * wavelengthError
